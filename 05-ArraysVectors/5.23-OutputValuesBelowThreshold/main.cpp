...
For coding simplicity, follow every output value by a comma, including the last one. You can also safely assume that the number of input integers is always less or equal 10.
